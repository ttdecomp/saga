...
TOOLCHAIN="${NDK_DIR}/toolchains/x86-4.7/prebuilt/windows-x86_64"
...
AR="${TOOLCHAIN}/bin/i686-linux-android-ar.exe"
RANLIB="${TOOLCHAIN}/bin/i686-linux-android-ranlib.exe"
