...
namespace {
    ...
    u32 host_previous_held_buttons[2];
} // namespace
...
void HostInputReset() {
    ...
    for (i32 port = 0; port < 2; ++port) {
        ...
        host_previous_held_buttons[port] = 0;
...
i32 ReadPad(i32 port) {
    ...
    gamepad.buttons_down_08 = tapped | (held & ~host_previous_held_buttons[port]);
    gamepad.unknown_0c = host_previous_held_buttons[port] & ~held;
    gamepad.unknown_10 = 0;
    gamepad.unknown_14 = 0;
    gamepad.unknown_18 = 0;
    gamepad.unknown_1c = 0;
    host_previous_held_buttons[port] = held;
