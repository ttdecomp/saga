...
void EndMission(MISSIONSYS_s *, i32, i32) {
}
...
void InitRopeMtl(char *, variptr_u *, variptr_u *) {
}

void InitStreaks(variptr_u *, variptr_u, char *) {
}

void InsideLineF(float, float, float, float, float, float) {
}
...
void ReadTerrain(unsigned char *, i32, i16 **, TERRSET *) {
}
...
void InsideLineXZ(float, float, float, float, float, float) {
}
...
void KaminoE_Draw(WORLDINFO_s *) {
}

void KaminoE_Init(WORLDINFO_s *) {
}

void KaminoF_Init(WORLDINFO_s *) {
}
...
void RedirectAnim(char *, ANIMREDIRECT *, ANIMLIST_s *, char *) {
}
...
void CalcValue1648(char *, i32, i32, float, ani3_scalemin_s *) {
}

void CanPullLevers(i32) {
}

void CheckCylinder(i32, i32, i32 *, i32) {
}
...
void CreateCopyMat(numtl_s *, i32, i32, i32, i32) {
}
...
void KeepWeaponOut(GameObject_s *) {
}

void LayerFromName(GAMECHARACTERDATA_s *, char *) {
}
...
void StartFallLand(GameObject_s *, i32) {
}
...
void BlobShadowFade(nuvec_s *, float, float, float) {
}
...
void CheckSphereTer(nuvec_s *, float) {
}
...
void DagobahB_Reset(WORLDINFO_s *) {
}
...
void DropInOutScale(GameObject_s *) {
}
...
void FactoryB_Reset(WORLDINFO_s *) {
}
...
void GunshipB_Reset(WORLDINFO_s *) {
}

void GunshipInLevel(LEVELDATA_s *) {
}

void InitSuperStory(i32) {
}

void InsidePolLines(float, float, float, float, float, float, float, float, float, nuvec_s *) {
}
...
void LSW_Hub_InitAI(WORLDINFO_s *) {
}

void Ledge_MoveCode(WORLDINFO_s *, GameObject_s *) {
}
...
void Mission_Active(MISSIONSYS_s *) {
}

void NbKaminoA_Init(WORLDINFO_s *) {
}
...
void ZipUp_MoveCode(GameObject_s *, i32) {
}
...
void getMaxTorpedos(GameObject_s *) {
}
...
void AddGameMsgCount(nuvec_s *, i32, i32, unsigned char, unsigned char, unsigned char, float) {
}
...
void CheckMissionEnd(MISSIONSYS_s *) {
}
...
void LSW_Hub_ResetAI(WORLDINFO_s *) {
}
...
void GizBuildit_Reset(GIZBUILDIT_s *, void *) {
}
...
void NeedsPretendAnim(GameObject_s *) {
}
...
void TightRope_SnapTo(GameObject_s *, nuvec_s *) {
}
...
void ChrisAnakinAReset(WORLDINFO_s *) {
}
...
void FullDeflectSmallY(nuvec_s *, nuvec_s *, nuvec_s *) {
}
...
void HothBattleA_Reset(WORLDINFO_s *) {
}

void HothBattleC_Reset(WORLDINFO_s *) {
}
...
void HothEscapeB_Reset(WORLDINFO_s *) {
}
...
void KaminoInDiscoRoom() {
}

void KeepPointOnScreen(nuvec_s *, nuvec_s *) {
}

void Ledge_FindNearest(WORLDINFO_s *, nuvec_s *, GameObject_s *, float *) {
}
...
void ReadInstAnimBlock(i32, nugscn_s *) {
}
...
void Shard_FindNearest(WORLDINFO_s *, nuvec_s *, GameObject_s *, float *) {
}
...
void TightRope_InRange(GameObject_s *, WORLDINFO_s *, nuvec_s *) {
}
...
void WeaponScalingCode(GameObject_s *) {
}

void ZipUp_FindNearest(WORLDINFO_s *, nuvec_s *, float, float *, i32 *, GameObject_s *, bool) {
}
...
void FindGameMsgsWithID(i32, i32, i32, GAMEMESSAGE_s *) {
}
...
void GetShootOrigin_LSW(GameObject_s *, nuvec_s *) {
}
...
void GizSpecial_GetName(GIZSPECIAL_s *) {
}
...
void Mission_FindTarget(MISSIONSYS_s *, u64 *) {
}
...
void RegisterGizActions(GIZACTIONDEFN_s *) {
}
...
void AIMoveToDestination(AISYS_s *, AIPACKET_s *, APIOBJECT_s *, i32) {
}

void ActivePlayerInRange(nuvec_s *, float, float *) {
}

void AddGoldBrickMessage(STATUSPACKET_s *, i16) {
}
...
void Attracto_GetPos_Top(ATTRACTO_s *, nuvec_s *) {
}
...
void Gizmo_FindNuSpecial(nugscn_s *, nuhspecial_s *, char *, i32, GIZMOSYS_s *, char *, char *) {
}

void Hat_GetAbsTargetPos(HATMACHINE_s *, nuvec_s *) {
}
...
void MakeJumpReachHeight(GameObject_s *, float, i32) {
}
...
void Missions_PickupsOff(MISSIONSYS_s *) {
}
...
void Attracto_FindNearest(WORLDINFO_s *, nuvec_s *, GameObject_s *, float *) {
}
...
void BonusGunshipA_Update(WORLDINFO_s *) {
}
...
void Mission_CurrentState(MISSIONSYS_s *) {
}

void Movies_ConfigureList(char *, variptr_u *, variptr_u *) {
}
...
void FindNearestTorpTarget(WORLDINFO_s *, nuvec_s *, float, unsigned char *) {
}
...
void GetShootDirection_LSW(GameObject_s *, nuvec_s *) {
}
...
void LedgeTerrain_MoveCode(GameObject_s *) {
}
...
void Missions_NumCompleted(MISSIONSYS_s *, MISSIONSAVE_s *, i32) {
}
...
void TightRope_FindNearest(nuvec_s *, WORLDINFO_s *, i32 *, float *) {
}
...
void CloudCityEscapeA_Reset(WORLDINFO_s *) {
}
...
void ReadInstAnimBlockDlist(i32, nugscn_s *) {
}
...
void CharConfig_ConfigureAll(i32, nufpcomjmp_s *) {
}
...
void CreateAlphaBlendTexture(variptr_u *, variptr_u, char *, i32, i32, i32, i32) {
}
...
void GizBuildit_SetVisibility(GIZBUILDIT_s *, i32) {
}
...
void EvaluateJointOrientationMtx(nugscn_s *, i32, numtx_s *) {
}
...
void SuperCounters_ResetProcessed(WORLDINFO_s *) {
}
...
void HitPoly(float, float, float, float, tertype *) {
}
...
void InitShop(WORLDINFO_s *) {
}

void ItemMenu(MENU_s *) {
}

void JumpCode(GameObject_s *, i32, i32, u32, i32, i32, i32) {
}
