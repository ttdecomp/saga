...
static __used__ double DistanceToPlane(nuvec_s*, nuvec_s*, nuvec_s*) { return {}; }
...
static __used__ bool Attack_UpdateHint(HINT_s*) { return {}; }



static __used__ void * CreatePodRaceMine(nuvec_s*) { return {}; }
