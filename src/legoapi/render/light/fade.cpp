...
void FadeSystem::SetFade(FADETYPE const &, u32) {
}

void FadeSystem::SetStage(char) {
}
...
void FadeStillWipe::Init(FADEINFO_s *) {
}
...
void FadeStill::Init(FADEINFO_s *) {
}
