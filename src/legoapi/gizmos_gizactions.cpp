...
void Action_SetState(AISYS_s *, AISCRIPTPROCESS_s *, AIPACKET_s *, char **, i32, i32, float) {
}
...
static __used__ void GizActions_GoToNewLevel(GIZFLOW_s *, FLOWBOX_s *, char **, int) {
}
...
static __used__ void GizActions_GoThroughDoor(GIZFLOW_s *, FLOWBOX_s *, char **, int) {
}
