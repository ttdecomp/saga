...
typedef struct PAI_s {
    ...
    u8 pad0b[0x394 - 0x368]; // 0x368..0x394
...
typedef struct APIOBJECT_s {
    ...
    f32 pos_y;                            // 0x84
    f32 pos_z;                            // 0x88
    undefined field_0x8c[0x190 - 0x8c];   // 0x8c .. 0x190
    f32 field_0x190;                      // 0x190
    f32 field_0x194;                      // 0x194
    f32 field_0x198;                      // 0x198
    undefined field_0x19c[0x1e0 - 0x19c]; // 0x19c .. 0x1e0
...
typedef struct GameObject_s {
    ...
    u8 pad_f01[0xf04 - 0xf01];    // 0x0f01 .. 0x0f04
    u8 field_0xf04;               // 0x0f04
    u8 pad_f05[0x1050 - 0xf05];   // 0x0f05 .. 0x1050
