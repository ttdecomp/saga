...
extern "C" {
    ...
    void aieditor_SetCurrentScript(void) {
    }
    ...
    void instNuGCutLocatorUpdate(void) {
    }
    ...
    void instNuGCutSceneStart(void) {
    }
