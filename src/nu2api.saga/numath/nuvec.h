...
/// @details Computes the cross product of the two vectors formed from the differences between v0 and basepnt and v1 and basepnt and stores the result in v.
/// @param v The vector to store the result in
